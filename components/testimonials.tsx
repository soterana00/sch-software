...
const testimonials = [
  {
    name: "Soterana00YT",
    company: "StorcraftHub",
    content:
      "As The Owner Of This SCH Software I Launched it since 2025@.",
    categories: [1, 3, 5],
  },
  {
    name: "Oday Khaled",
    company: "StorCraftHub",
    content:
      "Oday Khaled , is Our Resources Creator [Images , SVGs]",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Storcrafthub",
    content:
    "Abbdelrahman Mostafa , Is Our Second Programmer and He Is the First Moderator For SCH",
    categories: [1, 2, 5],
  },
  {
    name: "Abdullah Wael",
    company: "Storcrafthub",
    content:
    "Our First Programmer , And The Second Moderator Of SCH System",
    categories: [1, 4],
  },
  {
    ...
    company: "STORCRAFTHUB",
    content:
    "Abdulla Ayman , Is Our Third Programmer And The Third Moderator Of SCH System",
    categories: [1, 3, 5],
  },
  {
    name: "Abdullah Ahmed",
    company: "Storcrafthub",
    content:
    "Abdulla Ahmed < Is Our Forth Programmer And The Key Developer Of SCH Security System",
    categories: [1, 3],
  },
  {
    name: "Ali Hasan Desoky",
    company: "Storcrafthub",
    content:
    "Ali Hasa Desoky > is Our Second Media Creator",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Storcrafthub",
    content:
    "Abdelrahman Khaled << Our Third Media Creator",
    categories: [1, 4],
  },
  {
    name: "Nagwa SHa3ban",
    company: "StorcraftHUb",
    content:
    "OUR FIRST <<<< SESSION CREATOR - EXPERT MANAGER",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            The Members Of StorCraftHub Company And SCH Developers
          </p>
        </div>
